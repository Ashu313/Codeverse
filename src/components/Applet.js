...
import Preview from './homepage/homepage';
...
const navigate = useNavigate();
  ...
  return (
    ...
    <Routes>
      <Route path="/ide/:roomId" element={<Applet />} />  {/* Use the IDE component in the route */}
      {/* Other routes... */}
      ...
      <Route
        ...
        element={
          <div>
            {isDocId ? (
              <>
                <div>chutiya aadmi randi saala</div>
                <Header
                  userInfo={user}
                  runCode={runCode}
