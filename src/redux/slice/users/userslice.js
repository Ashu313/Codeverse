...
try{
    const {data}=await axios.post('http://localhost:3001/api/users/login',payload,config)
...
try{
    const {data}=await axios.post('http://localhost:3001/api/users/register',payload,config)
    return data;
}
catch(error)
{
